...
return [
    ...
    // 【注意】METRIC_DRIVER 的值与和 prometheus.yml 文件中的 job_name 一致；
    ...
    'metric' => [
        'prometheus' => [
            ...
            // 【注意】端口号参考 docker/prometheus-conf/prometheus.yml
            'scrape_host' => env('PROMETHEUS_SCRAPE_HOST', 'prometheus'), // 容器内部地址
            'scrape_port' => env('PROMETHEUS_SCRAPE_PORT', '9503'),
            'scrape_path' => env('PROMETHEUS_SCRAPE_PATH', '/metrics'),
            'push_host' => env('PROMETHEUS_PUSH_HOST', 'prometheus'), // 容器内部地址
